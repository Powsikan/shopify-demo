...
console.log("afrin",data)
console.log("afrin-purch",data.purchaseDate)
  let purchaseDate = []
  let totalSales = []

  useEffect(()=>{
    purchaseDate = data.map(d=>d.purchaseDate)
    totalSales = data.map(d=>d.totalSalesAmount)
  },[data])
...
credits:{
  ...
  return(
    <>
    <div>
      <Card sx={{width:"600px",height:"400px", marginLeft:"0px", alignContent:"center"}}>
